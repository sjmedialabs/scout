...
useEffect(() => {
  ...
  //   ],
  // }))
  let recieverId=(dynamicActiveConversation || []).participantsAre[0]===user.id?(dynamicActiveConversation || []).participantsAre[1]:(dynamicActiveConversation || []).participantsAre[0];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6 min-h-[100vh]">
        ...
        <Card className="rounded-2xl p-4 bg-white">
          ...
          <div className="relative mb-4 h-2 bg-white">
            ...
            <Input
              ...
              onChange={(e)=>{
                setFileteredDynamicConversation(()=>dynamicConversation.filter((eachItem:any)=>eachItem.participant.name.trim().toLowerCase().includes(e.target.value.trim().toLowerCase())))
              }}
            />
          </div>
        ...
        >
            ...
            (
              <div className="text-center">
               <p className="text-gray-500 mt-10">No Conversations Started yet</p>
              </div>
            )
          }
        ...
        {/* CHAT PANEL */}
        {
          !resLoading && !failed && (dynamicActiveConversation || []).length!==0 ?(
          ...
          <div className="flex items-start justify-between bg-[#f9f9f9] px-6 py-4  border-b">
            <div className="flex items-center gap-3">
              <img
                src={dynamicActiveConversation.participant.image || "https://i.pravatar.cc/100?img=32"}
          ...
          <div className="px-6 py-4 border-t">
              ...
              {uplodedUrl.url && (
                <div>
                  {uplodedUrl.url.match(/\.(jpg|jpeg|png|gif|webp)$/i) ? (
                    ...
                    <a href={uplodedUrl.url} target="_blank">View Uploaded File</a>
                  )}
                </div>
              )}
              </div>
            ...
            <div className="flex items-center gap-3 bg-gray-50 rounded-full px-4 py-2">
              ...
              <button  onClick={sendMessage} disabled={sendMsgLoading}><Send
                className="h-5 w-5 text-blue-600 cursor-pointer"
              /></button>
