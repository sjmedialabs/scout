...
const ReviewsPage=()=>{
     ...
     return(
       <div className="space-y-6">
                <div>
                  <h1 className="text-3xl font-bold text-[#F4561C] my-custom-class mb-0">Client Reviews</h1>
                  <p className="text-[#656565] font-medium text-lg">View and respond to client feedback</p>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row 
                ...
                <div>
                  ...
                  <StarRating rating={review.qualityRating} size={16} showValue={false} />
                </div>
        
                <div>
                  <p className="text-sm text-center font-bold mb-1">Cost</p>
                  <StarRating rating={review.costRating} size={16} showValue={false} />
                </div>
        
                <div>
                  <p className="text-sm text-center font-bold mb-1">Timeliness</p>
                  <StarRating rating={review.scheduleRating} size={16} showValue={false} />
                </div>
              </div>
