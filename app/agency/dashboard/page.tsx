          ...
          <div className="space-y-3">
            ...
            <Card className="rounded-2xl shadow-lg bg-white p-3 pl-0">
              <CardHeader className="h-8">
                <CardTitle className="text-lg h-5 text-orangeButton my-custom-class">Active Projects</CardTitle>
                <CardDescription className="text-gray-500">Your current ongoing projects</CardDescription>
              </CardHeader>
              <CardContent>
