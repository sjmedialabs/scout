...
import { mockAdminStats, mockAdminUsers, mockReportedContent, mockSubscriptionStats } from "@/lib/mock-data";
import {
  Users,
  FileText,
  AlertTriangle,
  ...
  return (
    <div className="space-y-10">
      ...
      <div>
        ...
        <p className="text-gray-500">Platform management and insights</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <DashboardCard
          ...
          helper={`${stats.totalRequirements} requirements posted`}
        />
      ...
      {/* Recent activity  */}
      {/* <RecentActivity users={users} reportedContent={reportedContent} /> */}
    </div>
  );
}
