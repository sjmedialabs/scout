   ...
   console.log("Fetched Wish list data is:::",wishListData)
    return(
        <div  className="space-y-6 p-3 md:p-6">
            <div>
              <h1 className="text-3xl text-[#F4561C] my-custom-class leading-6">Wish List</h1>
                    ...
                    {wishListData.map((provider)=>(
                        ...
                        <div className="p-4 sm:p-6">
                            ...
                            <div className="flex items-center gap-1 text-sm">
                                ...
                                <span className="font-semibold">{provider.agency.rating}</span>
                                <span className="text-muted-foreground">({provider.agency.reviewCount})</span>
                            </div>
                            </div>
